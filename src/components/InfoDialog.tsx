    ...
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth scroll="paper">
      ...
      <DialogContent dividers>
        <Section title="1. Caricare e mixare i brani">
          ...
          passaggio tra Deck 1 e Deck 2. Puoi anche cliccare/trascinare direttamente sulla barra di avanzamento del
          brano per saltare a un punto preciso.
        </Section>

        <Section title="2. Performance Pad (hot cue)">
        ...
        <Section title="3. Automix (TRANSITION FX)">
          ...
          velocità (beatmatching automatico) prima del passaggio.
        </Section>

        <Section title="4. Preview in cuffia (PFL)">
        ...
        <Section title="6. Coda per deck">
          Ogni deck può avere più brani in fila: se mandi un brano su un deck già occupato, si mette in coda invece di
          interrompere quello in corso. Quando il brano attuale finisce da solo, parte automaticamente il prossimo in
          coda; il pulsante "SKIP ▶" (visibile solo se la coda non è vuota) salta subito, senza aspettare la fine.
        </Section>

        <Section title="7. Limiti da conoscere (YouTube)">
          ...
          effetto</b>, il <b>preview in cuffia non è disponibile</b> e il <b>tempo/pitch</b> di fatto non cambia (YouTube
          supporta solo poche velocità fisse — 0.75x, 1x, 1.25x... — e il range del fader tempo, ±8%, è troppo piccolo
          per raggiungerle). Su questi aspetti i file locali restano l'esperienza completa.
        </Section>

        <Section title="8. Controller vs mouse/touch">
